        ...
        <>
            <main>
                ...
                <div className="relative h-auto bg-[url(src/assets/hero-image.png)] bg-[position:center_57%] bg-no-repeat bg-cover w-screen pt-[47px] ">
                    ...
                    {/* Hero title */}
                    <div className="font-[Arial] relative top-[105px] w-full flex flex-col items-center justify-center px-[115px]">
                    ...
                    {/* Hero banners */}
                    <div className="relative z-20 mt-[10px] pt-[125px] mb-10 px-[115px] grid grid-cols-3 gap-4">
                ...
                {/* About Container */}
                <div className="bg-white relative z-10 -mt-[220px] pt-[300px] pb-[400px] px-[115px] [clip-path:polygon(0_50px,100%_0,100%_100%,0_100%)] flex justify-between">
                    <div className="font-[Arial]">
                        ...
                        <p className="text-[14px] mt-[28px] font-[400] text-[#535353] w-[550px] leading-[28px]">
                        ...
                        <button className="bg-rgb(124,186,32) h-[43px] w-[190px] border text-white">Join Now</button>
                    </div>
                    <div>
                        <img src="src/assets/about-image.png" alt="gym bro" />
                    </div>
                </div>
