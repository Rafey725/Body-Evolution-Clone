        ...
        <>
            <header className="fixed z-30 w-full box-border bg-[#262626]   border-b border-white">
                <div className="flex flex-col lg:flex-row items-end mx-[5.625rem] px-[15px] w-auto h-[164px] justify-between ">
                    <div id="hamburger-container" className=" flex items-center justify-between pt-11 gap-0.5 cursor-pointer lg:hidden">
                        MENU
                        <div className="hamburger flex flex-col gap-[2.5px] relative left-[50px]">
                    ...
                    <div className="text-[17px] font-[Arial] w-full h-[60%] grid grid-cols-[auto_1fr] gap-25 grid-rows-1 items-center">
                        <a href="#" className="-ml-[30px] w-auto inline">
